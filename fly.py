# -*- coding: utf-8 -*-
"""
Created on Sun Dec 15 20:05:56 2019
...
latit_HRK, longit_HRK = float(HRK['position']['latitude']), HRK['position']['longitude']

latitude_list = [ latit_HRK, latit_AKL] 
longitude_list = [  longit_HRK ,longit_AKL] 
  
gmap3 = gmplot.GoogleMapPlotter(latit_AKL, longit_AKL, 53) 
